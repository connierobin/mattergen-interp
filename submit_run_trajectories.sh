#!/bin/bash
#SBATCH --job-name=run_trajectories
#SBATCH --output=jobs/run_trajectories/job_%j.out
#SBATCH --error=jobs/run_trajectories/job_%j.err
#SBATCH --ntasks=1
...
# Run your script
python mattergen/scripts/run_trajectories.py
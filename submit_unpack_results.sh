...
#SBATCH --output=jobs/unpackresults/job_%j.out
#SBATCH --error=jobs/unpackresults/job_%j.err
#SBATCH --ntasks=1
...
# Run your script
python mattergen/scripts/diffusion_step_analysis/unpack_results.py